...
_These Terms are a working template tailored to SwappUp. They must be reviewed by qualified legal counsel before public launch._
...
You must be at least 18 years old and legally able to enter into a binding contract to use SwappUp. You must complete identity verification before you can buy or sell on the platform.

## 3. The marketplace role

SwappUp is a venue that connects buyers and sellers. SwappUp is **not** a travel agent, airline, train operator, ticket reseller or travel insurer. The actual transport contract sits between the original carrier and the passenger named on the ticket.

We do not own, control, transfer or guarantee the tickets, credits or vouchers listed on the platform. Sellers are solely responsible for the accuracy of their listings and for performing the name change with the carrier.

## 4. Listings and seller obligations

By creating a listing you confirm that:

- You are the lawful holder of the ticket, credit or voucher.
- The ticket is transferable under the carrier's rules.
- All information you provide (route, date, fare, name-change fee, restrictions) is accurate.
- You will complete the name change to the buyer within the deadline shown in the order.
- You will not list a ticket whose departure is less than 24 hours away.
...
SwappUp may charge a service fee, which will always be displayed before checkout. Payments are processed by our payment provider (Stripe). You agree to their terms in addition to ours.
...
The SwappUp name, logo, software and content are owned by SwappUp or its licensors. You may not copy, modify or redistribute them without our written permission.

## 9. Disclaimers

The Service is provided "as is". To the maximum extent permitted by law, SwappUp disclaims all implied warranties, including merchantability and fitness for a particular purpose.

SwappUp does not guarantee that any specific carrier will accept a name change, that any listing is accurate, or that the Service will be uninterrupted or error-free.

## 10. Limitation of liability

To the fullest extent permitted by law, SwappUp's total liability to you in connection with the Service is limited to the greater of (i) the fees you paid to SwappUp in the twelve months before the event giving rise to the claim, or (ii) EUR 100.

SwappUp is not liable for indirect, incidental, special, consequential or punitive damages.

## 11. Termination

You may close your account at any time from the Account screen. We may suspend or terminate your account if you breach these Terms or if required by law. Provisions that by their nature should survive (including liability limits) will survive termination.

## 12. Changes to the Terms

We may update these Terms from time to time. When the version date changes, we will ask you to review and re-accept them before continuing to use the Service.

## 13. Governing law

These Terms are governed by the laws of England and Wales. Disputes will be brought before the courts of London, without prejudice to any mandatory consumer-protection rights you have under your local law.
