...
export const landingContent = {
  en: {
    ...
    productScreenLabel: (i: number) => `Product screen ${i}`,
    productScreenHint: "Drop real screenshots into these slots.",
  ...
  it: {
    ...
    productScreenLabel: (i: number) => `Schermata prodotto ${i}`,
    productScreenHint: "Inserisci qui gli screenshot reali del prodotto.",
