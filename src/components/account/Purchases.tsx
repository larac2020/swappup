            ...
            <div key={p.id} className="glass rounded-2xl p-4">
              <div className="flex items-center gap-3">
                ...
                <div className="text-right">
                  ...
                  <Badge variant="outline" className={`text-xs ${p.status === "completed" ? "bg-success/10 text-success border-success/30" : "bg-warning/10 text-warning border-warning/30"}`}>{p.status}</Badge>
                </div>
              </div>
            </div>
          ))}
