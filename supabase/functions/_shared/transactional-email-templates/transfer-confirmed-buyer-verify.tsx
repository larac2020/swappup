...
const dict = {
  en: {
    ...
    intro48: 'within 48 hours',
    introAfter: ' to release the payment. Your money stays safely with us until you confirm.',
    ...
    amountPaid: 'Amount paid (held safely until you confirm)',
    nextSteps: 'Next steps',
    s1Bold: 'If everything looks right:', s1: ' head back to the swappup app within ', s1B: '48 hours', s1After: ' and confirm your booking. Only at that point we will release the payment to {seller} and your purchase is finalised.',
  ...
  it: {
    ...
    intro48: 'entro 48 ore',
    introAfter: ' per sbloccare il pagamento. I tuoi soldi restano al sicuro con noi finché non confermi.',
    ...
    amountPaid: 'Importo pagato (custodito al sicuro fino alla tua conferma)',
    nextSteps: 'Prossimi passi',
    s1Bold: 'Se è tutto a posto:', s1: ' torna sull\'app swappup entro ', s1B: '48 ore', s1After: ' e conferma la prenotazione. Solo a quel punto invieremo il pagamento a {seller} e l\'acquisto sarà finalizzato.',
    s2Bold: 'Se qualcosa non va', s2: ' (nome errato, volo sbagliato, prenotazione mancante, ecc.): segnala il problema dalla stessa schermata in app. I tuoi soldi restano al sicuro con noi finché il problema non è risolto — nessun pagamento viene inviato finché non confermi.',
...
const Email = ({ buyerName, sellerName, newBookingRef, surname, trip, purchaseId, orderNumber, totalPrice, locale }: Props) => {
