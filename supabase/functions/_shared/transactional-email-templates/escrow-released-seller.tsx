...
const dict = {
  ...
  it: {
    preview: 'La tua vendita è completata e il bonifico è in arrivo',
    hi: 'Ciao {name},', hiThere: 'Ciao,',
    intro: 'Ottime notizie! {buyer} ha confermato il cambio del biglietto e la vendita è completata. Il pagamento',
    intro2: ' è ora in arrivo sul tuo conto.',
    tripTitle: 'La tua prenotazione',
    payoutLabel: 'Importo che riceverai',
    whatNext: 'Cosa succede ora',
    whatNextBody1: 'Il bonifico di solito arriva sul conto entro ',
    ...
    subjectWithOrder: 'Vendita completata, il pagamento è in arrivo (Ordine {order})',
    subject: 'Vendita completata, il pagamento è in arrivo',
  },
} as const
